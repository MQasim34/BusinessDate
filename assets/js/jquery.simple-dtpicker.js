...
(function ($) {
	...
	**/
	...
	var draw = function ($picker, option, year, month, day, hour, min) {
		...
		var $combinedDiv = $('<div class="going">');
		$combinedDiv.append($link_before_month);
		$combinedDiv.append($now_month);
		$combinedDiv.append($link_next_month);
		var $newText = $('<div class="available"></div>')
		$newText.text('Available')
		...
		if ($picker.data("dateOnly") === true) {
			...
			$timelist.css("height", Math.max($calendar.innerHeight() - 10, 290) +
				'px');
			...
			// 	var $o = $('<div>');
			// 	var $radio = $('<input type="radio" name="time">');
			...
			while (hour_ * 100 + min_ < maxTime[0] * 100 + maxTime[1]) {
				var $o = $('<div>');
				var $fordot = $('<div class="fordtoss"><div class="dotsInner"></div></div>')
				// var $radio = $('<input type="radio" name="time">');
				...
				// Add radio input field to the beginning of $o
				$o.append($fordot);
				...
				// Append time text after the radio input field
				$o.append(oText);
			...
			// while (hour_ * 100 + min_ < maxTime[0] * 100 + maxTime[1]) {
			// 	var $o = $('<div>');
			// 	var $radioDot = $('<div class="checkBox"></div>'); // Add this line
			// 	// var $radio = $('<input type="radio" name="time">');
			...
			// 	// Append radio dot element to $o
			// 	$o.append($radioDot);

			// 	var oText = "";
			// 	if ($picker.data("amPmInTimeList")) {
			// 		var amPm = hour_ >= 12 ? "PM" : "AM";
			// 		oText = /*zpadding*/ (hour_ > 12 ? hour_ - 12 : (hour_ < 1 ? 12 : hour_));
			// 		oText += ":" + zpadding(min_);
			// 		oText += ' ' + amPm;
			// 	} else {
			...
			// 		/* selected time */
			// 		$o.addClass('active');
			// 		// $radio.prop('checked', true); // Check the radio input
			// 		$radioDot.show(); // Show the radio dot
			// 		timelist_activeTimeCell_offsetTop = $o.offset().top;
			// 	}
